...
object Main {
  def main(args: Array[String]) {
    ...
    val paramGrid = new ParamGridBuilder()
      .addGrid(myLR.maxIter, Array(5, 25, 45, 70, 85, 100))
      .addGrid(myLR.regParam, Array(0.001, 0.1, 0.6, 1.5, 2.0 ))
      .build()

    //.addGrid(myLR.elasticNetParam, Array( 0.01, 0.05, 0.09, 0.3, 0.5, 0.9))
    ...
    val bestModel = cvModel.bestModel.asInstanceOf[PipelineModel].stages(7).asInstanceOf[LinearRegressionModel]
